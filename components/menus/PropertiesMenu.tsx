...
import { Interaction, IconStyle } from '../../types';
  ...
  const renderIconControl = (label: string, propName: string) => {
    ...
    return (
        <div className="space-y-2">
            ...
            {iconName && (
                <div className="bg-gray-50 dark:bg-gray-750 p-2 rounded border border-gray-200 dark:border-gray-700 grid grid-cols-2 gap-2">
        ...
        {activeTab === 'interactions' && (
          <div className="space-y-4">
            <button
              ...
              className="w-full py-2 bg-indigo-50 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 text-sm font-medium rounded hover:bg-indigo-100 dark:hover:bg-indigo-900 flex items-center justify-center gap-2 transition-colors"
            >
