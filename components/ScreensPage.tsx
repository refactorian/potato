...
export const ScreensPage: React.FC<ScreensPageProps> = ({ project, setProject, setActiveTab, onExport, setSelectedScreenIds, setSelectedElementIds }) => {
  ...
  const handleAddScreen = (groupId?: string) => {
      ...
      setProject({ ...project, screens: [...project.screens, newScreen], activeScreenId: newId });
      setSelectedScreenIds([newId]);
      setSelectedElementIds([]);
      setActiveTab('screens');
  };
  ...
  const toggleGroupCollapse = (groupId: string) => {
      setCollapsedGroups(prev => 
          // Fixed typo: replaced 'id' with 'groupId'
